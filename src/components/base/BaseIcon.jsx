...
const TooltipWrapper = ({
  ...
  return (
    <>
      ...
      {isVisible && (
        <div
          className="fixed z-50 px-3 py-2 text-sm text-white dark:text-black bg-gray-900 dark:bg-gray-300 rounded-md shadow-lg whitespace-nowrap pointer-events-none"
          style={tooltipStyle}
        >
          {tooltip}
        </div>
